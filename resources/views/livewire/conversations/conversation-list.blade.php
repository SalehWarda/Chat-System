<div>
    ...
    @forelse($conversations as $conversation)
        ...
        <a href="{{route('chat.show',$conversation)}}" class="list-group-item list-group-item-action  rounded-0

          {{\Illuminate\Support\Str::contains(request()->path(), $conversation->uuid) ? 'active text-white' : 'list-group-item-light'}}


            ">
            <div class="media"><img src="{{asset('theme/image/user.jpg')}}"
                ...
                <div class="media-body ml-4">
                    ...
                    <p class="font-italic mb-0 text-small">
                        ...
                        @if(!auth()->user()->hasRead($conversation))
                            <span
                                class="{{\Illuminate\Support\Str::contains(request()->path(), $conversation->uuid) ?'bg-white' :'bg-primary'}}
                                    mr-2 rounded-circle"
